...
<template>
    <v-form ref="form">
        ...
        <v-row>
            <v-col cols="6">
                <v-text-field label="Email" v-model="model.Email.value" :rules="model.Email.rules"
                    required></v-text-field>
            </v-col>
            <v-col cols="6">
        ...
        <v-row>
            <v-col cols="6">
                <v-text-field label="Password" v-model="model.Password.value" :rules="model.Password.rules"
